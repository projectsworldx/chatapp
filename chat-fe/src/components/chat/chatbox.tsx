            ...
            <Grid item xs={9}>
                <List className={classes.messageArea}>
                    ...
                    <ListItem key="2">
                        <Grid container>
                            <Grid item xs={12}>
                                <ListItemText style={{ textAlign: 'right' }} primary="Hey, Iam Good! What about you ?"></ListItemText>
                            </Grid>
                            <Grid item xs={12}>
                                <ListItemText style={{ textAlign: 'right' }} secondary="09:31"></ListItemText>
                            </Grid>
                        </Grid>
                    </ListItem>
                    <ListItem key="3">
                        <Grid container>
                            <Grid item xs={12}>
                                <ListItemText style={{ textAlign: 'right' }} primary="Cool. i am good, let's catch up!"></ListItemText>
                            </Grid>
                            <Grid item xs={12}>
